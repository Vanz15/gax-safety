"""
Interactive Explainable AI (XAI) tool using Generative Attribution eXplanation (GAX).

This script helps visualize why the model makes a specific prediction for a single X-ray image.
It runs an optimization process to find which pixels are most important for the model's 
prediction. Once finished, it opens an interactive window with a slider, allowing you to 
watch the heatmap evolve step-by-step and see how it impacts the model's confidence.
"""
import os
import torch
...
if __name__ == "__main__":
    ...
    LOCAL_IMAGE_PATH = "jpeg_dataset/test/pneumonia/0ae5dcc7-197d-4d59-991a-3b93f3a1e760.jpg" 
